...
- Stale strings worth fixing (one-liners, no data risk): `catalog_coverage: "series-level for 33 sources…"` (`catalog.ts:19`, actually 322 served); `SUPPORTED_SOURCES` header comment "The 191 sources" (stale); `updater-daily.yml` comment drift (285/335/270 vs real 305/355/290). Remember: **the Worker deploys manually** — fixing the string in the repo changes nothing until `npx wrangler deploy` + live check.
