"""IMF Government Finance Statistics — Statement of Sources and Uses of Cash — DIRECT from api.imf.org (flow GFS_SSUC, agency IMF.STA).
...
FLOW, AGENCY, SOURCE = "GFS_SSUC", "IMF.STA", "imf_gfsssuc_direct"
