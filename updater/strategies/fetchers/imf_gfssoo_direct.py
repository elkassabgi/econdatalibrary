"""IMF Government Finance Statistics — Statement of Operations — DIRECT from api.imf.org (flow GFS_SOO, agency IMF.STA).
...
SIZE: this is the largest of the family — 475,049 series over 220 indicators, and a
serieskeysonly listing alone is ~57 MB. Expect a slow first pass.
"""
from . import _imf_direct as _base

FLOW, AGENCY, SOURCE = "GFS_SOO", "IMF.STA", "imf_gfssoo_direct"
