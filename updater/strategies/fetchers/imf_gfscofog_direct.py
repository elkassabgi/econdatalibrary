"""IMF Government Finance Statistics — Government Expenditures by Function (COFOG) — DIRECT from api.imf.org (flow GFS_COFOG, agency IMF.STA).
...
FLOW, AGENCY, SOURCE = "GFS_COFOG", "IMF.STA", "imf_gfscofog_direct"
