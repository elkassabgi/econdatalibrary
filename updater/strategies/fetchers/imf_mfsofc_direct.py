"""IMF Monetary and Financial Statistics — Other Financial Corporations (MFS_OFC) — DIRECT from
api.imf.org (agency IMF.STA). One of the five flows IMF SPLIT the former MFS dataset into.
...
carries no MFS flow; it carries the MFS_* family — MFS_DC, MFS_MA, MFS_OFC, MFS_FMP, MFS_IR (all
IMF.STA; the dated *_VINTAGE snapshots of each are deliberately ignored). Probe-confirmed
2026-08-05, and current_vintage() returned MFS_OFC:7.0.0 live the same day. One source id per
...
Adding `imf_mfsofc_direct` takes nothing from `imf_mfs`; supersession is #46, reserved.
"""
from . import _imf_direct as _base

FLOW, AGENCY, SOURCE = "MFS_OFC", "IMF.STA", "imf_mfsofc_direct"
