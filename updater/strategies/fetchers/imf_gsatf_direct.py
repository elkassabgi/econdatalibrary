"""IMF Gender Statistics — access to finance (GS_ATF) — DIRECT from api.imf.org (agency
...
current_vintage() returned GS_ATF:1.0.0 live 2026-08-05 (cycle 15 of the econ-updater
...
Adding `imf_gsatf_direct` takes nothing from the legacy gender stores; supersession is #46, reserved.
"""
from . import _imf_direct as _base

FLOW, AGENCY, SOURCE = "GS_ATF", "IMF.STA", "imf_gsatf_direct"
