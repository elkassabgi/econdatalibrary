"""IMF Financial Soundness Indicators — Balance Sheet, Income Statement — DIRECT from api.imf.org (flow FSIBSIS, agency IMF.STA).
...
FLOW, AGENCY, SOURCE = "FSIBSIS", "IMF.STA", "imf_fsibsis_direct"
