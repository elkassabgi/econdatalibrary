"""IMF Monetary and Financial Statistics — Monetary Aggregates (MFS_MA) — DIRECT from
...
2026-08-05, and current_vintage() returned MFS_MA:10.0.1 live the same day. One source id per
...
Adding `imf_mfsma_direct` takes nothing from `imf_mfs`; supersession is #46, reserved.
"""
from . import _imf_direct as _base

FLOW, AGENCY, SOURCE = "MFS_MA", "IMF.STA", "imf_mfsma_direct"
