"""IMF Gender Statistics — labor and employment (GS_LEPM) — DIRECT from api.imf.org (agency
...
current_vintage() returned GS_LEPM:2.0.0 live 2026-08-05 (cycle 15 of the econ-updater
...
Adding `imf_gslepm_direct` takes nothing from the legacy gender stores; supersession is #46, reserved.
"""
from . import _imf_direct as _base

FLOW, AGENCY, SOURCE = "GS_LEPM", "IMF.STA", "imf_gslepm_direct"
