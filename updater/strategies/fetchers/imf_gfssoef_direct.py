"""IMF Government Finance Statistics — Statement of Other Economic Flows — DIRECT from api.imf.org (flow GFS_SOEF, agency IMF.STA).
...
NEW COVERAGE: no legacy source corresponds to this flow, so it adds 12,720 series we have
never carried rather than duplicating an existing id.
"""
from . import _imf_direct as _base

FLOW, AGENCY, SOURCE = "GFS_SOEF", "IMF.STA", "imf_gfssoef_direct"
