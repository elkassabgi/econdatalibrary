"""IMF Monetary and Financial Statistics — Depository Corporations (MFS_DC) — DIRECT from
...
2026-08-05, and current_vintage() returned MFS_DC:8.0.0 live the same day. One source id per
...
Adding `imf_mfsdc_direct` takes nothing from `imf_mfs`; supersession is #46, reserved.
"""
from . import _imf_direct as _base

FLOW, AGENCY, SOURCE = "MFS_DC", "IMF.STA", "imf_mfsdc_direct"
