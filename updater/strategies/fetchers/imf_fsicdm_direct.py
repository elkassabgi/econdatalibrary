"""IMF Financial Soundness Indicators — Concentration and Distribution Measures — DIRECT from api.imf.org (flow FSICDM, agency IMF.STA).
...
FLOW, AGENCY, SOURCE = "FSICDM", "IMF.STA", "imf_fsicdm_direct"
