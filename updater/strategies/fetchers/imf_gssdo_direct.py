"""IMF Gender Statistics — seats and decision-making offices (GS_SDO) — DIRECT from api.imf.org (agency
...
current_vintage() returned GS_SDO:1.0.0 live 2026-08-05 (cycle 15 of the econ-updater
...
Adding `imf_gssdo_direct` takes nothing from the legacy gender stores; supersession is #46, reserved.
"""
from . import _imf_direct as _base

FLOW, AGENCY, SOURCE = "GS_SDO", "IMF.STA", "imf_gssdo_direct"
