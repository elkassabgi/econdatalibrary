...
def parse_jsonstat2(data: dict, prefix: str, time_code: str | None = None) -> list[tuple[str, dt.date, float]]:
    ...
    INDICATOR) can never be mistaken for the time axis. Falls back to the value-first
    ...
    try:
        ...
        # Value-first stops a month axis (Menesis codes '01'..'12') from outranking GADS.
