...
~20M+ series in `data/clean_full` (e.g. vdem 77.4M rows, imf_ifs 13.5M,
...
| field | value |
|---|---|
| `series_id` | `<source>:<flow_id>` — a *browse* id (e.g. `istat:DCIS_POPRES1`) |
...
~2.5k indicators, vdem ~0.5k — *estimates to confirm at build*). This is
