...
<!-- ── ElkassabgiData family band ── -->
<section class="section" style="background:linear-gradient(135deg,var(--navy) 0%,var(--navy-light,#243044) 100%);text-align:center;padding:3.5rem 0">
  <div class="container">
    <a href="https://hfdatalibrary.com/" title="ElkassabgiData — one account, every library">
      <img src="assets/elkassabgidata-logo.svg" alt="ElkassabgiData" width="340" height="91" style="max-width:90%;height:auto">
    </a>
    <p style="color:rgba(255,255,255,.85);font-size:1.15rem;margin:1.2rem 0 .3rem;font-family:var(--serif)">One account. Every library.</p>
    <p style="color:rgba(255,255,255,.55);font-size:.9rem;max-width:640px;margin:0 auto">The free ElkassabgiData key unlocks the whole family:
      <a href="https://hfdatalibrary.com/" style="color:var(--gold)">HF Data Library</a> (1-minute U.S. equity data) and
      <strong style="color:#fff">Econ Data Library</strong> (this site) — with more libraries to come.</p>
  </div>
</section>
