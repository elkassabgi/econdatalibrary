...
(function(){{
  ...
  // Hourly bucket, NOT per-load. /v1/stats is edge-cached 6h (s-maxage=21600); a
  // millisecond cache-buster defeats it and sends every visitor to the origin (R709).
  fetch(API+"/v1/stats?h="+Math.floor(Date.now()/3600000)).then(function(r){{if(!r.ok)throw 0;return r.json();}}).then(function(d){{
...
<section class="section">
  <div class="container">
    ...
    <div class="grid-3">
      ...
      <a class="acard tile-link" href="catalog.html?pillar=research"><div class="card-icon">&#128218;</div><h3>Research Datasets</h3><p>Maddison Project (year 1 CE onward), Penn World Table, Barro-Lee, and more.</p><span class="tile-go">Browse sources &rarr;</span></a>
    </div>
...
def main():
    ...
    # metadata-only reference" rule; refused sources stay purged.)
    # ------------------------------------------------------------------ #
    records = []
