...
| stat_slovenia 1/2 "returned 200 but parsed 0 rows" (08-04) | Re-swept in the same run: healthy rotating sweep (74/146 groups, offset saved). CORRECTION: the tally DOES name them (the digest display truncates) — 1012308S + 1517309S "time axis parses to no dates" (the SURS numeric-category/archival class), 1506815S + 2221405S "non-empty body parsed 0 rows". NEXT: probe the 4 against the SURS API and classify (hagstofa-archival vs real break) |
