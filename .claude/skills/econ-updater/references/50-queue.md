...
| insee_bdm 201/201 + insee_melodi 129/144 transient-failed (verdicts 07-31) | Re-verdict run 31058253388 in flight (3h+ — consistent with recovered units deriving thousands of changed CSVs, which sits outside the 45-min per-unit SIGALRM) |
| stat_slovenia 1/2 "returned 200 but parsed 0 rows" (08-04) | In the same re-verdict run |
