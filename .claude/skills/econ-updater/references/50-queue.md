...
| imf_pgcs | 2,262 | PROBED 2026-08-05: successor = IMF.FAD:ICSD v1.0.0 'Investment and Capital Stock Dataset' — pgcs's kpriv/kgov/kppp capital-stock indicators ARE the ICSD content (name+content match); build imf_icsd_direct, confirm coverage at the proof run |
...
| imf_fiscaldecentralization | 8,398 | Successor IMF.STA:FD — ledger rename audit matched it at an IDENTICAL series count (8,398); current_vintage() CALLED live 2026-08-05: FD -> FD:6.0.0. Build imf_fd_direct (cycle 13 candidate) |
| imf_hpdd | 191 | Successor IMF.FAD:HPD — identical count (191) in the rename audit; current_vintage() CALLED live 2026-08-05: HPD -> HPD:1.0.0. Build imf_hpd_direct (cycle 14 candidate) |
